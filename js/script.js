...
onkeydown = function keyboardControls() {
  ...
  if (
    (catPosition == 1 && keyboardKey == 40) ||
    (catPosition == 1 && keyboardKey == 83)
  ) {
    move2();
  } else if (
    (catPosition == 2 && keyboardKey == 40) ||
    (catPosition == 2 && keyboardKey == 83)
  ) {
    move3();
  } else if (
    (catPosition == 2 && keyboardKey == 38) ||
    (catPosition == 2 && keyboardKey == 87)
  ) {
    move1();
  } else if (
    (catPosition == 3 && keyboardKey == 40) ||
    (catPosition == 3 && keyboardKey == 83)
  ) {
    move4();
  } else if (
    (catPosition == 3 && keyboardKey == 38) ||
    (catPosition == 3 && keyboardKey == 87)
  ) {
    move2();
  } else if (
    (catPosition == 4 && keyboardKey == 40) ||
    (catPosition == 4 && keyboardKey == 83)
  ) {
    move5();
  } else if (
    (catPosition == 4 && keyboardKey == 38) ||
    (catPosition == 4 && keyboardKey == 87)
  ) {
    move3();
  } else if (
    (catPosition == 5 && keyboardKey == 38) ||
    (catPosition == 5 && keyboardKey == 87)
  ) {
    move4();
  }
...
setInterval(() => {
  texttext.textContent = `shot: ${typeof Number(
    shot01Left.offsetLeft
  )} boss: ${typeof Number(moonBoss.offsetLeft)}`;
}, 1000);
...
const aaaa = asdf => console.log(asdf);
